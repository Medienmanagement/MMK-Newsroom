...
class Admin_AnnouncementController
    ...
    implements \Controller_Action_InterfaceForm, \Controller_Action_InterfaceRedirect
{
    ...
    public function getForm()
    {
        ...
        return new Form_TagForm($configForm->announcement);
    }
    ...
    {
        return $this->_helper->entityManager()->getRepository('\Newsroom\Entity\Announcement');
    }
